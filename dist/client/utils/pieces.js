...
const p1 = [3, 4, 5, 6]; // r to p2 [-5, 5, 15, 25]
...
const p2 = [5, 15, 25, 35]; // r to p3 [23, 24, 25, 26]
...
const p3 = [3, 4, 5, 6]; // r to p0 [-16, -6, 4, 14]
...
const p4 = [5, 15, 24, 25]; // r to p5 [4, 14, 15, 16]
...
const p5 = [4, 14, 15, 16]; // r to p6 [5, 6, 15, 25]
...
const p6 = [5, 6, 15, 25]; // r to p7 [14, 15, 16, 26]

const r6 = ([a, b, c, d]) => [a + 9, b + 9, c + 1, d + 1]; //    #o#
//      #
//
//


const p7 = [4, 5, 6, 16]; // r to p4 [-5, 5, 14, 15]
...
const p8 = [5, 15, 25, 26]; // r to p9 [14, 15, 16, 24]

const r8 = ([a, b, c, d]) => [a + 9, b, c - 9, d - 2]; //    #o#
//    #
//
//


const p9 = [4, 5, 6, 14]; // r to p10 [-6, -5, 5, 15]
...
const p10 = [4, 5, 15, 25]; // r to p11 [6, 14, 15, 16]
...
const p11 = [6, 14, 15, 16]; // r to p8 [5, 15, 25, 26]
...
const p12 = [4, 5, 14, 15]; // r to p13 [4, 5, 14, 15]
...
const p13 = [4, 5, 14, 15]; // r to p14 [4, 5, 14, 15]
...
const p14 = [4, 5, 14, 15]; // r to p15 [4, 5, 14, 15]
...
const p15 = [4, 5, 14, 15]; // r to p12 [4, 5, 14, 15]
...
const p16 = [4, 14, 15, 25]; // r to p17 [5, 6, 14, 15]
...
const p17 = [5, 6, 14, 15]; // r to p18 [5, 15, 16, 26]
...
const p18 = [4, 14, 15, 25]; // r to p19 [14, 15, 23, 24]

const r18 = ([a, b, c, d]) => [a + 10, b + 1, c + 8, d - 1]; //     o#   //
//    ##    //
//          //
//          //


const p19 = [5, 6, 14, 15]; // r to p16 [-6, 4, 5, 15]
...
const p20 = [4, 5, 6, 15]; // r to p21 [-5, 4, 5, 15]
...
const p21 = [5, 14, 15, 25]; // r to p22 [5, 14, 15, 16]
...
const p22 = [5, 14, 15, 16]; // r to p23 [5, 15, 16, 25]
...
const p23 = [5, 15, 16, 25]; // r to p20 [14, 15, 16, 25]
...
const p24 = [5, 14, 15, 24]; // r to p25 [13, 14, 24, 25]

const r24 = ([a, b, c, d]) => [a + 8, b, c + 9, d + 1]; //    #o
//     ##
//
//


const p25 = [4, 5, 15, 16]; // r to p26 [-5, 4, 5, 14]
...
const p26 = [5, 14, 15, 24]; // r to p27 [4, 5, 15, 16]
...
const p27 = [4, 5, 15, 16]; // r to p24 [6, 15, 16, 25]
